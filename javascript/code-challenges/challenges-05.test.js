...
const addValues = (arr) => {
  // Solution code here...
  let arr2 = arr.reduce((accumulator, value) => {
...
uses reduce to find the total amount purchased. Each object contains the keys `item` and `purchasePrice` ]
like the example.
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let len = arr.reduce((accumulator, value, idx) => {
    return idx + 1;
  });
  return len;
};
...
below, uses reduce to return an array containing the names of the characters.
------------------------------------------------------------------------------------------------ */
...
const returnNames = (arr) => {
  // Solution code here...
  let arr2 = arr.reduce((accumulator, value, idx) => {
...
const reversedString = (str) => {
  // Solution code here...
  let x= str.split('') .reduce((r, c) => c + r);
  return x;
};
